...
export default function MessagingPage({ user, onChatOpen }: MessagingPageProps) {
  ...
  usePushNotifications(user.id, client as any)
    ...
    return (
      <div className="flex items-center justify-center h-full py-20 px-4">
        <div className="glass-card rounded-3xl p-8 text-center max-w-md">
          ...
          <h3 className="text-lg font-light text-text-primary mb-2">Unable to load messaging</h3>
          <p className="text-text-muted text-sm mb-4">
            {initError || 'There was a problem connecting to the chat service. Please try refreshing the page.'}
          </p>
          <button
            onClick={retryConnection}
            className="px-6 py-2 bg-taupe-700 text-white rounded-2xl hover:bg-taupe-800 transition-all font-light"
          >
            Retry Connection
          </button>
        </div>
