...
For European users, additional rights and protections apply under GDPR, including rights to access, correct, delete, transfer, restrict, and object to processing of your personal information.`
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fade-in">
        ...
        <div className="px-8 py-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          {showDeleteConfirmation ? (
            ...
            <div className="space-y-3">
              ...
              {/* Parental Controls - Only show for minors */}
              {(() => {
                const storedUser = typeof window !== 'undefined' ? localStorage.getItem('user') : null
                const user = storedUser ? JSON.parse(storedUser) : null
                const isMinor = user?.ageCategory === 'minor'
                ...
                return (
                  <button
                    ...
                    className="w-full p-5 bg-blue-50/50 backdrop-blur-sm rounded-2xl hover:bg-blue-50 transition-all duration-300 shadow-sm hover:shadow-md border border-blue-200/50"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="text-left">
                          <p className="text-blue-700 font-light text-base flex items-center gap-2">
                            Parental Controls
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                            </svg>
                          </p>
                          <p className="text-blue-600 text-xs font-light">Manage account restrictions</p>
                        </div>
                      </div>
      ...
      {showParentalControls && !verifiedPin && (
