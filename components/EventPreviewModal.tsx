              ...
              {currentUserId ? (
                <>
                  ...
                  <div className="flex gap-2 items-center">
                    {/* Share Button - More Subtle */}
                    <button
                      onClick={handleShareEvent}
                      className="text-xs text-white/60 hover:text-white/90 transition-all duration-200 flex items-center gap-1 underline decoration-white/30 hover:decoration-white/60"
                    >
                    ...
                    {event.createdBy !== currentUserId && (
                      <>
                        ...
                        <button
                          ...
                          className="text-xs text-white/60 hover:text-red-400 transition-all duration-200 flex items-center gap-1 underline decoration-white/30 hover:decoration-red-400/60"
                          title="Report event"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                ...
                <>
                  ...
                  {/* Share Button for Non-logged in Users - Subtle */}
                  <button
                    onClick={handleShareEvent}
                    className="w-full text-center text-xs text-white/60 hover:text-white/90 transition-all duration-200 flex items-center justify-center gap-1 underline decoration-white/30 hover:decoration-white/60 py-2"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                    </svg>
